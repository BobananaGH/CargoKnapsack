...
def brute_force_rkp(cargo_list, capacity, gamma):
    ...
    Used only as a reference for validating LLPP on small
    ...
    for mask in range(1 << n):
        ...
        # nominal weight + Gamma largest uncertainties
...
# ============================================================
# Generate random RKP instance
# ============================================================

def generate_random_case():

    # Keep n small because brute force checks 2^n subsets.
...
def validate_case(
    ...
    if actual_profit != expected_profit:
        ...
        print()
        print(
            f"LLPP nominal weight: "
            f"{result['nominal_weight']}"
        )

        print(
            f"LLPP robust weight: "
